<template>
  <header>
    <nav class="navbar">
      ...
      <div class="navbar__item cart-btn">
        <nuxt-link active-class="active" to="/cart">
          <svg
          ...
          <span class="cart-btn__cnt">({{ quantityGoods }})</span>
        </nuxt-link>
      </div>
    </nav>
  </header>
...
export default {
  ...
  computed: {
    quantityGoods() {
      return this.$store.getters["cart/getQuantityGoods"];
    },
  },
};
</script>
